...
def getMove():
    answer = [
        ...
        "What do I look like, some kind of GameBoy?"
    ]
    return random.choice(answer)
...
def getHelpy():
    answer = [
        "Oh, sure, maybe I can help you. But I am more of a silent watcher...\nNonetheless, you can consider using me by issuing a command to me. I will ignore most of them, no doubt.\nBut a few, like /stats and /d20 should work.\nOthers are secret.\n\nBecause every girl has her secrets."
    ]
    return random.choice(answer)
